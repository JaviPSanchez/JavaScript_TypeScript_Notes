...
/*
Esto es asi porque funciona con la idea de nullish values instead of falsy values, y los NULLISH VALUES
solo pueden ser null o undefined. (NOT "0" or ' '). Todos los nullish values will short circuit the evaluation.
*/
...
/*
?? --> Nullish Coalescing OPERATOR se corta con los Falsy values, lo usamos para evitar que cuando tenemos un
0 o ' ' devuelve a si mismo, pero no con NaN o undefined.
*/
