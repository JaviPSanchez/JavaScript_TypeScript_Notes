...
const restaurant = {
  ...
  orderPizza: function (mainIngredient, ...otherIngredients) {
    ...
    console.log(otherIngredients); // ["onions", "olives", "spinach"]
  },
};
/*
The REST PATTERN looks like the SPREAD OPERATOR, it has the same syntax with the three dots but it does the opposite of the SPREAD OPERATOR. En vez de separar junta.
Usábamos el SPREAD OPERATOR to build new ARRAYS o OBJECTS, o para pasar múltiples VALUES en una función.
Para diferenciar el SPREAD de REST simplemente saber que cada uno se hace en un lado diferentes de una igualdad, el SPREAD en el lado izquierdo, mientras que el REST en el derecho, aunque esto no deberíamos fijarnos mucho..., más bien en que queremos obtener, If you want to break an array into several variables, you're using spread syntax. If you're taking several variables and putting them into one array, you're using rest syntax.
*/
...
/*
Hasta ahora era para hacer DESTRUCTURING, pero si quisiésemos pasar múltiples argumentos a una función nos podemos servir del SPREAD OPERATOR, básicamente lo que hicimos con el ejemplo de los ingredientes con el SPREAD:
*/
...
/*
Vamos a crear otro METHOD en nuestro OBJECT restaurant, necesitamos pedir una pizza con al menos un ingrediente puesto que el resto son opcionales, para esto REST PARAMETRS are perfect!
*/
restaurant.orderPizza('mushrooms', 'onions', 'olives', 'spinach');
//mushrooms ["onions", "olives", "spinach"]
/*
El primer elemento se almacena en el ARGUMENT mainIngredient y el resto en otherIngredients como un ARRAY. Si solo pidiésemos un ingrediente, quedaría el ARRAY otherIngredients vacía.
*/
