...
//Comenzamos creando una funcion muy simple, a la que le pasamos los parametros flightNumber, number of passengers and the price y usaremos este info para crear un OBJECT, en concreto un ARRAY usando un OBJECT LITERAL SYNTAX, con sus propiedades,
...
Sin embargo hacerlo de esta forma es un tantop ugly y BOILER PLATE code, este es el metodo ES5, con ES6 hay una mejor forma de hacerlo, asignando directamente los valores en los argumentos! facil y para toda la familia!
