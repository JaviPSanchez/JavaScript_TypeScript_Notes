...
/*
Luego podemos decir que todo el SCOPE dentro de estas funciones es privado, esta ENCAPSULATED.
Los datos ENCAPSULADOS y DATA PRIVACY son conceptos de extrema importancia en programacion,
en muchas ocasiones necesitaremos proteger nuestras variables de ser sobre escritas por otras partes
del programa o incluso external libreries.

Este es el porque de porque se inventaron las IIFE, esto no es un feature de JS en si,
es un pattern que los developers han inventado.
