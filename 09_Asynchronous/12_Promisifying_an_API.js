...
/*
Let's now keep promisifying things and this time around, we're gonna promisify the geolocation API.
...
*/
const firstGetPosition = function () {
...
*/
const secondGetPosition = function () {
  return new Promise(function (resolve, reject) {
    navigator.geolocation.getCurrentPosition(
