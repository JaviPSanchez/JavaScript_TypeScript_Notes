...
*/
//Creamos dos funciones basicas que simplemente toman dos STRINGs, la primera toma un STRING y lo reemplaza por otro nuevo pero sin espacios
...
//Ahora podemos crear nuestras HIGHER ORDER FUCNTION, puesto que toma otra funcion en uno de sus argumetos "func"

const transformer = function (str, func) {
  console.log(`Original string: ${str}`);
  console.log(`Transformed string: ${func(str)}`);
  console.log(`Transformed by: ${func.name}`); //Las funciones no solo puyeden usar METHODs sino que tambien PROPERTIES como .name
};
