...
/*
Nos permite expand an ARRAY into all its elements. So basically, unpacking all the ARRAY elements at one. Para poder utilizar el SPREAD OPERATOR hay que escribir ...ARRAY Nom
...
/*
Solo podemos usar el SPREAD OPERATOR when building an ARRAY or when passing arguments into a function. But, what we can't do is to use this to build a string using a template literal.
*/
...
const restaurant = {
  ...
  starterMenu: ['Focaccia', 'Bruschetta', 'Garlic Bread', 'Caprese Salad'],
  mainMenu: ['Pizza', 'Pasta', 'Risotto'],
  foundedIn: 2021, //nuevos METHODS.
  founder: 'Javier', // nuevos METHODS.
  openingHours: {
    thu: {
      open: 12,
      close: 22,
